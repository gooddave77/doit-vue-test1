    ...
    <header>
            ...
            <div class="contentbox">
                <div class="logo">
                    <button v-on:click="goToPage('/main')" >
                        <img src="/images/logo.png" alt="이지스 로고" />
                    </button>
                </div>
                <div class="system">
        ...
        <nav>
            <div class="contentbox">
                ...
                <!--<li><button>도서 소개</button></li>
                    ...
                    <li v-for="(item, index) in menulists" :key="index" v-on:click="goToPage(item.menutext)" >
        ...
        <b-modal id="login" class="modal" hide-footer>
            ...
            <div class="modalcontainer">
                <div class="loginform">
                    <label for="id"><i class="bi bi-file-persion" />아이디</label>
            ...
            <div class="modalcontainer">
                <b-form @submit="Joinmember">
                    <b-form-group
                        ...
                        label="아이디"
                        label-for="id"
                        description="4~15자리 이내 영문, 숫자로만 입력하세요">
                        <b-form-input
                            id="id"
                            v-model="form.id"
                            type="text"
                    ...
                    <b-form-group
                        ...
                        label="비밀번호"
                        label-for="password"
                        description="8자리 이상의 영문, 숫자로만 입력하세요">
                        <b-form-input
                            id="password"
                            v-model="form.pass"
                            type="password"
